...
// pasamos la prop que es llamada desde el router para centralizar el titulo o lo que queramos (esto fue un ejemplo)
// pero puedes pasarle mas props desde router y que se centralice todo
    defineProps({
            titulo: {
                type: String,
            }
...
/>
    ...
    name="apellido"
    label="Apellido"
    placeholder="coloca el apellido aqui"
    validation="required"
    ...
    label="Email"
      name="email"
    placeholder="coloca el email aqui"
    ...
    />
      ...
      <FormKit
        ...
        validation="required"
        :min="9"
        :validation-messages="{ required:'telefono obligatorio' }"
        validation-visibility="submit"
        />
      <FormKit
       name="empresa"
